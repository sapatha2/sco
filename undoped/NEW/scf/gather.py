...
df=None
direcs=['../../PBE0/CHK']*5+['../../PBE0/COL']*1+['../../PBE0/FLP']*1+['../../PBE0/FM']*1
totspin=[0]*5+[1]*1+[2]*1+[4]*1
base_energy=[-9.2123749620223E+02]*5+[-9.2122638412999E+02]*1+[-9.2122636552756E+02]*1+[-9.2121137910381E+02]*1
rem=[[[],[]],
     [[],[55]],
     [[],[65]],
     [[],[55]],
